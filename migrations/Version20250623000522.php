 ...
 */
final class Version20250623000522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user ADD reset_token VARCHAR(100) DEFAULT NULL, ADD token_expires_at DATETIME DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user DROP reset_token, DROP token_expires_at
        SQL);
    }
}
